...
session_title = "Escanor v79 (Unified Dossier Cadence & Preflight Priming)"
...
config_data = {
    ...
    "description": "Escanor v79 CIO operating with unified dossier cadence, dedicated active position review, 5-Pod adversarial reasoning, Reality Reconciliation, and pre-flight backtest mirror",
