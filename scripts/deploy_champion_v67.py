...
session_title = "Escanor v67 (Fully Grounded Tools, Backtest Rigor & Live Broker Precision)"
...
config_data = {
    ...
    "description": "Escanor v67 CIO equipped with Grounded Backtest Replay, Dynamic Tool Aliases, and MT5 Broker Precision"
}
...
print(f"-> Escanor v67 deployment ready!")
