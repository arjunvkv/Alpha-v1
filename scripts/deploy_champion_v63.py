...
session_title = "Escanor v63 (Alpha Granger 7-Layer Desk)"
...
1. `graphiti_search_facts(patterns=[...])`: Query 2-4 descriptive thought tags to inspect past walks, historical base rates, and documented traps.
