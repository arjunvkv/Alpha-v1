...
session_title = "Escanor v66 (Adaptive Macro Vision & Causal Facts Cadence)"
...
config_data = {
    ...
    "description": "Escanor v66 CIO equipped with 3-Tier Macro Causal Aperture, Live World Events RSS wire, and Graphiti Facts Cadence"
}
