        ...
        if ready_for_dispatch:
            ...
            if triggered_watch is not None:
                ...
                prompt = (
                    ...
                    f"### POD 3: TECHNICAL STRUCTURE & ROADWAYS\n"
                    f"• 4TF posture (H4/H1/M15/M5), key structural levels, FVG zones & CE fill %, unmitigated demand/supply magnets, sweep verification (penetrated vs mid-air reversal).\n\n"
