        ...
        if ready_for_dispatch:
            ...
            if open_tickets:
                ...
                idle_prompt = (
                    ...
                    f"{matrix_formatted}\n"
                    f"===========================================================\n"
                    f"EXECUTIVE ACTION: Synthesize the 5-Element O.C.E.A.N. Framework ([O] Order Flow & CVD, [C] 4TF Confluence, [E] Macro Lifecycle, [A] COT & ULM Precedents, [N] Volume Profile POC/VAH/VAL & FVG Geometry). Map your Upper Sell Bracket (Tier 1 Limit @ resistance) and Lower Buy Bracket (Tier 1 Limit @ support). If price is at/approaching a bracket and the 3 Pillars pass (R:R >= 2.5:1 with structural SL), stage your calibrated pending limit order (place_pending_order with volume 0.5-1.0 lot). If price is floating in mid-range chop between brackets, output your resting structural grid and stand calmly flat without forcing trades. Dollar-based auto-exit is OFF. "
