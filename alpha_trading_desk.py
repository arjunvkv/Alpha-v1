        ...
        if ready_for_dispatch:
            ...
            if triggered_watch is not None:
                ...
                prompt = (
                    ...
                    f"### REALITY RECONCILIATION: PREDICTION VS. LIVE TAPE (Did price follow the roadmap anticipated last cycle, or did it move another way? Diagnose any trap or divergence)\n"
